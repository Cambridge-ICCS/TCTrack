...
* :meth:`TCTracker.trajectories` to read any outputs generated by the tracking algorithm and parse
...
* :meth:`TCTracker.run_tracker` that will perform end-to-end tracking, reading inputs and generating
  ...
  :meth:`TCTracker.trajectories` to a :doc:`CF-conventions compliant NetCDF file <../data/output_file>`.
...
:meth:`TCTracker.trajectories` method has been provided.
